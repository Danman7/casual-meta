  ...
  return (
    <>
      ...
      <section>
        ...
        <p>
          <strong>11</strong> is the fastest (7 frames), safe (-1 on block){' '}
          <em>punisher</em> and <em>combo starter</em>. You can hit-confirm into
          a special, or stagger
          <strong>112</strong> to test the opponent’s reactions.
        </p>

        <p>
          <strong>42</strong> is a slower, safe (0 on block),
          ...
          buffer a Kameo attack from <strong>42 Grab</strong>.
        </p>

        <p>
          <strong>F2</strong> is a key <em>advancing mid</em>, controlling
          space, and checking crouchers. It leads into the hit-confirmable{' '}
          <strong>F21</strong> that is safer to check before a full string, an
          EX teleport (the normal one won't work), or Kameo.{' '}
          <strong>F212</strong> puts Sektor airborne and can be followed by air
          specials, but is unsafe.
        </p>

        <p>
          <strong>B2</strong> is your unsafe, standing, overhead starter, that
          leads into the very unsafe <strong>B22</strong> (-18 on block).
          Mix-up, yes, but difficult to convert out of unless covered by a Kameo
          assist.
        </p>

        <p>
          <strong>B3</strong> is the safer, low part of your mix-up. It leads
          into <strong>B34</strong> which is much safer than the overhead route
          and hits multiple times, which can help against armored attempts. It
          is a key part of Sektor’s close-range offense.
        </p>
      </section>
    </>
  )
